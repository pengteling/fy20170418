...
[note]
一、<a href="https://www.processon.com/diagraming/592fa790e4b0f57fff75136a">了解Web开发</a><br>

二、<a href="https://www.processon.com/diagraming/58ec9437e4b0c9097c370a91">了解简单的前端开发工作流程</a><br>

三、了解web开发的一些历史：<br>
1、<a href="http://blog.csdn.net/comsharp/article/details/4532152">那些著名网站的90年代</a>  <br>
2、Web开发从最初的纯 HTML 到 CGI、PHP\ASP\JSP\ASP.net、Ajax、Rails、NodeJS<br>
3、从Frontpage 到 网页三剑客（dreamwaver\fireworks\flash）到现代编辑器（sublime\atom\webstorm\hbuilder\aptana\notepad++\editplus\IntelliJ IDEA\vs<br>
4、WEB图表技术：从服务器生成图片、VML到flash图表到纯JS框架hightcharts/Flot到基于html5/canvans/svg的图表框架Echarts、D3.js  <br>
5、手机WEB：从WML（WAP1.0）到XHTML（WAP2.0）到HTML5（各种前端框架）<br>
6、从Web1.0 - >  web2.0 -> 移动互联网 <br>
[/note]
...
1、HTML英文全写:HyperText Markup Language 超文本标记语言 <br>
2、由于HTML5的新增API及JS的强大功能，浏览器不再是单纯浏览网页，而是变成了一个编程的SDK与操作系统互通的中间层。<a href="https://www.processon.com/diagraming/58ef41ade4b0cb4162a0a590">链接</a><br>
3、H5 != HTML5 <br>
国内H5 => H5营销广告 <br>
起初，html5广告指代的是利用该技术实现的互联网广告，而现在的H5广告则范指那些在网络社交媒体中传播的带有特效、互动体验和声效的Web 网页。<br>
易企秀 <br> ih5  <br>
...
[note]
1、CSS3 是最新的 CSS 标准。CSS3相比增加了很多样式设置，新增了动画，并向前兼容。<br>
2、建议学习时先知其然再知其所以然。<br>
3、CSS看似简单，其实博大精深。<br>
4、案例链接：<br>
 <a href="https://codepen.io/pengteling/pen/OmKKzW">3D旋转的立方体</a>
 <a href="http://codepen.io/pengteling/pen/BpvPpE">纯CSS画叮当猫</a> 
 <a href="http://codepen.io/jaysalvat/pen/HaqBf">纯CSS实现蒙娜丽莎</a>
[/note]
[slide]
## 了解JavaScript
...
6、ICON字体图标<br>
7、雪碧图、切片、<a href="http://www.changan.com.cn/purchase/cx/">兼容1</a><a href="file:///K:/fy3/index.html">兼容2</a>等<br>
[/note]
...
* 2、MVC
* 3、从服务端渲染到客户端渲染：前端MVC、MVVM框架<br>
...
HTML5酷站：http://html5-showcase.com
实际商业项目
